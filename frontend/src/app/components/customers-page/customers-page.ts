...
export class CustomersPageComponent {
  ...
  readonly allVisibleSelected = computed(() => {
    ...
    return currentCustomers.every((customer) =>
  ...
  toggleSelectAllVisible(checked: boolean): void {
    ...
    if (checked) {
      const merged = new Set([...this.selectedCustomerIds(), ...visibleIds]);
      this.selectedCustomerIds.set([...merged]);
      return;
    }

    this.selectedCustomerIds.set(
      this.selectedCustomerIds().filter((id) => !visibleIds.includes(id)),
    );
  }
